...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'product_invoice_manager' => 'getProductInvoiceManagerService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProductInvoiceBundle', ($this->targetDirs[2].'/Resources/ProductInvoiceBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ProductInvoiceBundle', ($this->targetDirs[3].'\\src\\Product\\InvoiceBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d027b17f027a7089968ddb9c1e0aeb9ce97c9e57128f00c870e02cb99ecb76b1');
    ...
    /**
     * Gets the 'product_invoice_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Product\InvoiceBundle\Manager\InvoiceManager A Product\InvoiceBundle\Manager\InvoiceManager instance.
     */
    protected function getProductInvoiceManagerService()
    {
        return $this->services['product_invoice_manager'] = new \Product\InvoiceBundle\Manager\InvoiceManager($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ProductInvoiceBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Product\\InvoiceBundle/Resources/views'), 'ProductInvoice');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('d8ccea5d34a393d741921b9f2d137beaf63e87a6');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56bb7b426f35a5.83576887')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProductInvoiceBundle' => 'Product\\InvoiceBundle\\ProductInvoiceBundle',
            ...
            'secret' => 'd8ccea5d34a393d741921b9f2d137beaf63e87a6',
            'locale' => 'en',
            ...
            'kernel.secret' => 'd8ccea5d34a393d741921b9f2d137beaf63e87a6',
